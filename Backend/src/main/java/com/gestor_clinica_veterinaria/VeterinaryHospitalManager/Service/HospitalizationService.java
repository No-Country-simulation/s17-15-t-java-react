...
////      }
//
public List<HospitalizationResponse> getHospitalizationsByPetId(Long petId) {
    ...
    return hospitalizationMapper.toDtoList(combinedHospitalizations.stream().collect(Collectors.toList()));
}
