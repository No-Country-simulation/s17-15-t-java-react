...
import EditConsultation from './EditTreatment';
...
function TreatmentCard({ itemObj, deleteItem, updateListArray }) {
    ...
    const URL = `https://veterinaria-bef3.onrender.com/treatment/all`;
